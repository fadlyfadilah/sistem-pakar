        ...
        <div class="row mb-2">
            <div class="col-md-8 offset-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Tata Penggunaan Sistem</h5>
                        1. Pilih Meni Diagnosis.<br/>
                        2. Setelah di halaman diagnosis silahkan isi data diri terlebih dahulu.<br/>
                        3. jika sudah mengisi data diri anda akan di alihkan ke form pertanyaan.<br/>
                        4. pilih gejala yang sesuai.<br/>
                        5. lalu tekan tombol Proses Diagnosa
                    </div>
                </div>
            </div>
        </div>
