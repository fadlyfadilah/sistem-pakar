...
$gejalas = query("SELECT * FROM gejalas");
?>
<!doctype html>
<html lang="en">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($gejalas as $gejala) : ?>
                                        <tr data-entry-id="<?= $gejala['id'] ?>">
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-success" href="edit.php?id=<?= $gejala["kode_gejala"]; ?>">
                                                    <i class="fa-solid fa-pen-to-square"></i>Ubah
                                                </a>
                                                <a class="btn btn-xs btn-danger" href="#" onclick="confirmDelete(<?= $gejala["id"]; ?>);">
