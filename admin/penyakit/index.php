                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($penyakits as $penyakit) : ?>
                                        <tr data-entry-id="<?= $penyakit['id'] ?>">
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-success" href="edit.php?id=<?= $penyakit["kode_penyakit"]; ?>">
                                                    <i class="fa-solid fa-pen-to-square"></i>Ubah
                                                </a>
                                                <a class="btn btn-xs btn-danger" href="#" onclick="confirmDelete(<?= $penyakit["id"]; ?>);">
