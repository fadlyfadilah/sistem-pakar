...
$id = $_GET["id"];
$gejala = query("SELECT * FROM gejalas WHERE kode_gejala = '$id'")[0];
// var_dump($gejala['id']);
// die;
?>
<!doctype html>
...
<body>
    ...
    <div class="navbar border border-dark">
        ...
        <div>
            <a href="../gejala/" class="activee">Daftar
                Gejala</a>
        </div>
        <div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_gejala" class="form-control" id="kode_gejala" placeholder="G0.." value="<?= $gejala['kode_gejala'] ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="nama_gejala">Nama Gejala</label>
                                <input type="text" name="nama_gejala" class="form-control" id="nama_gejala" placeholder="Gejala..." value="<?= $gejala['nama_gejala'] ?>" required>
                            </div>
