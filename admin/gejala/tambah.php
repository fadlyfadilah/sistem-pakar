                    ...
                    <div class="card-body">
                        <form method="POST" action="" autocomplete="off">
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_gejala" class="form-control" id="kode_gejala" placeholder="G0.." required>
                            </div>
                            <div class="form-group">
                                <label for="nama_gejala">Nama Gejala</label>
                                <input type="text" name="nama_gejala" class="form-control" id="nama_gejala" placeholder="Gejala..." required>
                            </div>
    ...
    if (isset($_POST["submit"])) {
        ...
        if (tambahgejala($_POST) > 0) {
            echo "<script>
                    Swal.fire({
                        title: 'Berhasil',
                        text: 'Berhasil Menyimpan Gejala!',
                        icon: 'success'
                    }).then(function() {
